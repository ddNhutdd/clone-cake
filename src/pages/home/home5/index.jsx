	...
	return (
		<div className={`${css.home5} ${renderDarkTheme()}`}>
			...
			<div className={`${css.home5__imageLeft}`}>
				<img src='src/assets/imgs/image-36.png' alt='image' />
				<img src='src/assets/imgs/image-37.png' alt='image' />
				<img src='src/assets/imgs/image-38.png' alt='image' />
				<img src='src/assets/imgs/image-39.png' alt='image' />
			</div>
			<div className={`${css.home5__imageRight}`}>
				<img src='src/assets/imgs/image-31.png' alt='image' />
				<img src='src/assets/imgs/image-32.png' alt='image' />
				<img src='src/assets/imgs/image-33.png' alt='image' />
				<img src='src/assets/imgs/image-34.png' alt='image' />
				<img src='src/assets/imgs/image-35.png' alt='image' />
			</div>
		</div>
	);
}
