...
function Home2() {
		...
		},
		{
			...
			content: (
				<MarqueeItem
					...
					text={'Apptos'}
					icon={
						<img src='src/assets/imgs/aptosicon.png' alt='base' />
					}
				/>
			),
		},
		{
			...
			content: (
				<MarqueeItem
					...
					icon={
						<img
							src='src/assets/imgs/ethereumicon.png'
							alt='base'
						/>
					}
				/>
		...
		},
		{
			...
			content: (
				<MarqueeItem
					...
					text={'Polygon zkEVM'}
					icon={
						<img src='src/assets/imgs/polygonicon.png' alt='base' />
					}
				/>
			),
		},
		{
			...
			content: (
				<MarqueeItem
					...
					text={'zkSync Era'}
					icon={
						<img src='src/assets/imgs/zksyncicon.png' alt='base' />
					}
				/>
			),
		},
		{
			...
			content: (
				<MarqueeItem
					...
					icon={
						<img
							src='src/assets/imgs/arbitrumicon.png'
							alt='base'
						/>
					}
				/>
		...
		},
		{
			...
			content: (
				<MarqueeItem
					...
					text={'Linea'}
					icon={
						<img src='src/assets/imgs/lineaicon.png' alt='base' />
					}
				/>
			),
		},
	...
	return (
		<div className={`${css['home2']} ${renderDarkTheme()}`}>
			...
			<div
				className={`${css['home2__backgroundShape']} ${renderDarkTheme()}`}
			>
				<Theme1 />
			</div>
		</div>
