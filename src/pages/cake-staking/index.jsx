	...
	return (
		<div className={`${css.cakeStaking} ${renderDarkTheme()}`}>
				...
				<div className={css.cakeStaking__container}>
					<div className={css.cakeStaking__top__content}>
						<div className={css.cakeStaking__top_left}>
							<div className={css.cakeStaking__top__header}>
								CAKE Staking
							</div>
							<div className={css.cakeStaking__top__text}>
								Enjoy the benefits of weekly CAKE yield, revenue
								share, gauges voting, farm yield boosting,
								participating in IFOs, and so much more!
							</div>
						...
						<div className={css.cakeStaking__top__card}>
							...
							<div className={css.cakeStaking__top__card__input}>
								<div
									className={`${css.cakeStaking__top__card__input__group} ${css.cakeStaking__top__card__input__left}`}
								>
									<div>ADD CAKE</div>
									<div
										className={
											css.cakeStaking__top__card__input__item
										}
									>
										<div>
											<img
										...
										<div>
											...
											<div>~5,599,406,648.49 USD</div>
										</div>
									</div>
									<div
										className={
											css.cakeStaking__top__card__input__list
										}
									>
										<div
											className={`${css.cakeStaking__top__card__input__list__item} ${css.active} ${css.left}`}
										>
											25%
										</div>
										<div
											className={
												css.cakeStaking__top__card__input__list__item
											}
										>
											50%
										</div>
								...
								<div
									className={`${css.cakeStaking__top__card__input__group} ${css.cakeStaking__top__card__input__right}`}
								>
									...
									>
										<div
											className={`${css.cakeStaking__top__card__input__list__item} ${css.active} ${css.right}`}
										>
											1W
										</div>
										<div
							...
							<div
								className={css.cakeStaking__top__card__overide}
							>
								<div
									className={
										css.cakeStaking__top__card__overide__header
									}
								>
									LOCK OVERVIEW
								</div>
								<div
									className={
										css.cakeStaking__top__card__overide__main
									}
								>
									<span
										className={
											css.cakeStaking__top__card__overide__main__item
										}
									>
								...
								<div
									className={
										css.cakeStaking__top__card__overide__info
									}
								>
									<div
										className={
											css.cakeStaking__top__card__overide__info__item
										}
									>
							...
							<div
								className={css.cakeStaking__top__card__actions}
							>
								<Button isDark={isDarkMode} className='w-100'>
									Connect Wallet
								</Button>
							</div>
						</div>
						<div className={css.cakeStaking__top__smallTitle}>
							Benefits of veCAKE
						</div>
						<div
							className={
								css.cakeStaking__top__secondCardContainer
							}
						>
			...
			<div className={css.cakeStaking__bottom}>
				<div className={css.cakeStaking__container}>
					<div className={css.cakeStaking__bottom__header}>
						And So Much More...
					</div>
